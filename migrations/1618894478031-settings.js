...
const settings = [
  ...
  },
  {
    ...
    value: '',
    name: 'Default Image When Model Is Offline',
    description: 'Default Image When Model Is Offline',
    public: true,
    group: 'custom',
    editable: true,
    meta: {
  ...
  },
  {
    ...
    description: 'Default commission for performer',
    public: false,
    group: 'commission',
    editable: true,
    type: 'commission',
  ...
  },
  {
    ...
    description: 'Default commission for studio',
    public: false,
    group: 'commission',
    editable: true,
    type: 'commission',
