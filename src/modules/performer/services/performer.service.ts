...
import { ModelNotFoundException } from 'src/modules/studio/exceptions/model-not-found.exception';
...
export class PerformerService {
  ...
  public async studioUpdate(
    id: string,
    payload: MemberSetActivePayload,
    studioId: ObjectId
  ) {
  ...
  public async updateBalance(id: string | ObjectId, amount: number) {
    return this.performerModel.updateOne(
      { _id: id },
      {
        $inc: {
  ...
  public async selfSuspendAccount(
